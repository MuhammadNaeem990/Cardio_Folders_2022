...
class ProductA_Fragment_page_Eight : Fragment() {
    ...
    override fun onCreateView(
        ...
        image1 = view.findViewById<View>(R.id.boschempa_id_page8_image1) as ImageView
        image2 = view.findViewById<View>(R.id.boschempa_id_page8_image2) as ImageView
        image3 = view.findViewById<View>(R.id.boschempa_id_page8_image3) as ImageView
        image4 = view.findViewById<View>(R.id.boschempa_id_page8_image4) as ImageView

        image5 = view.findViewById<View>(R.id.boschempa_id_page8_image5) as ImageView
        image6 = view.findViewById<View>(R.id.boschempa_id_page8_image6) as ImageView
        image7 = view.findViewById<View>(R.id.boschempa_id_page8_image7) as ImageView
        image8 = view.findViewById<View>(R.id.boschempa_id_page8_image8) as ImageView
        image9 = view.findViewById<View>(R.id.boschempa_id_page8_image9) as ImageView
        image10 = view.findViewById<View>(R.id.boschempa_id_page8_image10) as ImageView
        image11 = view.findViewById<View>(R.id.boschempa_id_page8_image11) as ImageView
...
//                    shine2.startAnimation(animation)
                    val animation_image6 = AnimationUtils.loadAnimation(
                        context, R.anim.button_animation
                    )
                    ...
                    val animation_image8 = AnimationUtils.loadAnimation(
                        context, R.anim.move_from_right_one_second
                    )
