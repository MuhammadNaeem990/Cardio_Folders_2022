...
class ProductB_Fragment_page_Four : Fragment() {
    ...
    override fun onCreateView(
        ...
        image_background = view.findViewById<View>(R.id.rova_page4_background) as ImageView
        image_header1 = view.findViewById<View>(R.id.rova_page4_header1) as ImageView
        image_header2 = view.findViewById<View>(R.id.rova_page4_header2) as ImageView
        image1 = view.findViewById<View>(R.id.rova_page4_image1) as ImageView
        image2 = view.findViewById<View>(R.id.rova_page4_image2) as ImageView
        image3 = view.findViewById<View>(R.id.rova_page4_image3) as ImageView
        image4 = view.findViewById<View>(R.id.rova_page4_image4) as ImageView
        image5 = view.findViewById<View>(R.id.rova_page4_image5) as ImageView
        ...
        val animation_image2 = AnimationUtils.loadAnimation(
            context, R.anim.move_from_left_two_sec
        )
