...
import app.folder.example.dell.Cardio_Folder_2022.SwipeViewPager_Adapter.Speciality.Adapter_Penicillin
import java.util.*
...
*/models = ArrayList()
        models?.add(Model(R.drawable.boschempa_page1_image1, R.drawable.boferin_title_text, "  "))
        models?.add(Model(R.drawable.boschempa_page1_image1, R.drawable.boferin_title_text, "  "))
        models?.add(
            Model(
                R.drawable.boschempa_page1_image1,
