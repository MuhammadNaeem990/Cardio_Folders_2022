...
import app.folder.example.dell.Cardio_Folder_2022.SwipeViewPager_Adapter.Speciality.Adapter_Spc_ABC
import java.util.*
...
*/models = ArrayList()
        models?.add(Model(R.drawable.boferin_title_text, R.drawable.boferin_title_text, "  "))
        models?.add(Model(R.drawable.boferin_title_text, R.drawable.boferin_title_text, "  "))
        models?.add(
            Model(
