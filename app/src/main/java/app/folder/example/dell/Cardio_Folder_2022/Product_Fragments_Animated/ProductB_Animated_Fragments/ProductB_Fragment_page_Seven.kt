...
class ProductB_Fragment_page_Seven : Fragment() {
    ...
    override fun onCreateView(
        ...
        image_background = view.findViewById<View>(R.id.rova_page7_background) as ImageView
        image_header1 = view.findViewById<View>(R.id.rova_page7_header1) as ImageView
        image_header2 = view.findViewById<View>(R.id.rova_page7_header2) as ImageView
        image1 = view.findViewById<View>(R.id.rova_page7_image1) as ImageView
        image2 = view.findViewById<View>(R.id.rova_page7_image2) as ImageView
        image3 = view.findViewById<View>(R.id.rova_page7_image3) as ImageView
        image4 = view.findViewById<View>(R.id.rova_page7_image4) as ImageView
        image5 = view.findViewById<View>(R.id.rova_page7_image5) as ImageView
        ...
        val animation_image3 = AnimationUtils.loadAnimation(
            context, R.anim.fade_in_three_sec
        )
