...
import app.folder.example.dell.Cardio_Folder_2022.Adapter_Animated.ProductE_Adapter
import app.folder.example.dell.Cardio_Folder_2022.R
import app.folder.example.dell.Cardio_Folder_2022.Transformations.CubeInDepthTransformation
...
class ProductE_Fragment_Main : Fragment() {
    ...
    override fun onCreateView(
        ...
        viewPager_complete!!.setPageTransformer(true, CubeInDepthTransformation())
