...
import app.folder.example.dell.Cardio_Folder_2022.Adapter_Animated.ProductC_Adapter
import app.folder.example.dell.Cardio_Folder_2022.R
import app.folder.example.dell.Cardio_Folder_2022.Transformations.ZoomOutTransformation
...
class ProductC_Fragment_Main : Fragment() {
    ...
    override fun onCreateView(
        ...
        viewPager_complete!!.setPageTransformer(true, ZoomOutTransformation())
