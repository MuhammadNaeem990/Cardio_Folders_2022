...
import app.folder.example.dell.Cardio_Folder_2022.SwipeViewPager_Adapter.Speciality.Adapter_Admin
import java.util.*
...
class Admin_Activity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        models?.add(Model(R.drawable.qzon_page1_image1, R.drawable.qzon_title_text, "  "))
